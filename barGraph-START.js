...
// let categoryLabels = {};
// fetch('https://gist.githubusercontent.com/alexrogers823/73335d86e2516993face9f7818bd9955/raw/89fa5fb90db60ff0949fd8af2d629b39d47d9dc6/barGraphCategories.json')
//   .then(blob => blob.json())
//   .then(data => {
//     categoryLabels = data;
...
const categoryAxis = d3.svg.axis()
  ...
  .scale(categoryScale)
  .tickFormat((d, i) => {
    // Using our category labels for x-axis
    categoryNames = [];
...
// Setting up the svg space for the graph
...
// This function is our data we are binding to.
// Question: Why do this instead of just binding what we have?
...
// Setting flag for pausing changes
let pause = false;

// Changing the data each second
let numeric = 1;
setInterval(() => {
  // As long as graph isn't "paused", the transitions will run
  if (!pause) {
